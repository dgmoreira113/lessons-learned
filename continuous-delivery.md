...
If you think about a continuum of time required to develop a software, from the largest period of time to the smallest period of time required, I would mention (1) Big Design Upfront - timeline for whole software, (2) Scrum - you break the whole project into smaller periods of 4 weeks, (3) Lean/Kanban - minimizes waste/work-in-progress and reduces cycle time, (4) Cowboy Coding - when developers have autonomy over the development process. 
